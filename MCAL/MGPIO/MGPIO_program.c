...
void MGPIO_voidToggleData(u8 Copy_u8PortName ,u8 Copy_u8PinNum)
{
		...
		switch(Copy_u8PortName)
		{
		case _GPIOA_PORT :  TOG_BIT(MGPIOA ->ODR,Copy_u8PinNum); break;

		case _GPIOB_PORT :  TOG_BIT(MGPIOB ->ODR,Copy_u8PinNum); break;

		case _GPIOC_PORT :  TOG_BIT(MGPIOC ->ODR,Copy_u8PinNum); break;

		case _GPIOD_PORT :  TOG_BIT(MGPIOD ->ODR,Copy_u8PinNum); break;

		case _GPIOE_PORT :  TOG_BIT(MGPIOE ->ODR,Copy_u8PinNum); break;

		case _GPIOH_PORT :  TOG_BIT(MGPIOH ->ODR,Copy_u8PinNum); break;
